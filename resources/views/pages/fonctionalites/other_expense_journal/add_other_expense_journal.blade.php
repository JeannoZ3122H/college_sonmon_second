...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Création de journal d'autre entrée en caisse /</span> nouveau journal d'autre entrée en caisse</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h4 class="card-header">Nouveau journal d'autre entrée en caisse</h4>

                    <div class="card-body pt-2 mt-1">
                        <form id="formAccountSettings" method="POST"
                            action="{{ route('dashboard.add_other_expense_journal_request') }}">
                            @csrf
