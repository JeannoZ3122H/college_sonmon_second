...
@section('title')
Liste des inscriptions en informatique
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-dark fw-light">Liste des inscriptions en informatique</span></h4>
    <a href="{{ route('dashboard.inscription_computer_science_student_step_one') }}" class="btn btn-primary text-white mb-3 mt-1 me-2">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body py-1 mb-lg-3 mb-2">
                ...
                @if (request()->route()->uri == 'search_computer_science_student/{type}')
                    <div class="col-12 text-end mb-3">
                        <a href="{{ route('dashboard.liste_computer_science_student') }}" class="btn btn-danger m-2">
                ...
                <div id="eventContentShowForms" class="col-12 d-flex justify-content-end">
                    <button type="button" onclick="eventForms('single')" class="btn btn-primary m-2">Rechecher par élève</button>
                ...
                <div id="isSearchByItem" class="d-none">
                    <div class="row justify-content-center">
                        <form action="{{ route('search_computer_science_student', 'single') }}" class="col-lg-8 col-12 mb-lg-0 mb-3" method="post">
                            @csrf
                            <div class="input-group">
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="search_single"><small>Entrer ici...</small></label>
                                </div>
                            </div>
                ...
                <div id="isSearchByDate" class="d-none">
                    <div class="row justify-content-center">
                        <form action="{{ route('search_computer_science_student', 'group') }}"
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-truncate">NOM ET PRENOMS</th>
                                        <th class="text-truncate">MATRICULE</th>
                                        <th class="text-truncate">CLASSE</th>
                                        <th class="text-truncate text-uppercase">MONTANT</th>
                                        <th class="text-truncate text-uppercase">Année scolaire</th>
                                        <th class="text-truncate">Numero d'urgence</th>
                                        <th class="text-truncate">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($liste_inscription_computer_science as $key => $item)
                                    <tr>
                                        <td>
                                            {{ $key+1 }}
                                        </td>
                                        ...
                                        <td class="text-truncate">{{ $item->scolarite_steps_price }}</td>
                                        <td class="text-truncate">{{ $item->inscription_years }}</td>
