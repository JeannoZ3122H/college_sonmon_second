...
@section('title')
Détails une inscription en informatique
@endsection
@section('content')
    <!-- Content -->
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Détails de inscription en informatique</span></h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    @if($infos)
                    <h4 class="card-header pb-2 text-uppercase" style="text-shadow: .4px 1.3px gray">Inscription en informatique du {{ $infos->movement_bank_date }}</h4>
