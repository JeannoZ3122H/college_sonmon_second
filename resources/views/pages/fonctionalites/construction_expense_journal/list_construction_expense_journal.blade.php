...
@section('title')
Liste de journal de dépense de constrcution
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-dark fw-light">Liste de journal de dépense de constrcution</span></h4>
    <a href="{{ route('dashboard.add_construction_expense_journal') }}" class="btn btn-primary text-white mb-3 mt-1 me-2">
        <i class="mdi mdi-plus-outline me-2"></i>
       Ajouter une dépense de constrcution
    </a>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body py-1 mb-lg-3 mb-2">

                @if (request()->route()->uri == 'search_construction_expenses_journal/{type}')
                    <div class="col-12 text-end mb-3">
                        <a href="{{ route('dashboard.liste_construction_expense_journal') }}" class="btn btn-danger m-2">
                ...
                <div id="eventContentShowForms" class="col-12 d-flex justify-content-end">
                    <button type="button" onclick="eventForms('single')" class="btn btn-primary m-2">Rechecher par dépense de constrcution</button>
                ...
                <div id="isSearchByItem" class="d-none">
                    <div class="row justify-content-center">
                        <form action="{{ route('search_construction_expenses_journal', 'single') }}" class="col-lg-8 col-12 mb-lg-0 mb-3" method="post">
                            @csrf
                ...
                <div id="isSearchByDate" class="d-none">
                    <div class="row justify-content-center">
                        <form action="{{ route('search_construction_expenses_journal', 'group') }}"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">{{ $item->construction_date_depense }}</td>
                                        <td class="text-truncate">{{ $item->construction_pc_number }}</td>
                                        <td class="text-truncate">{{ $item->construction_designation }}</td>
                                        <td class="text-truncate">{{ $item->construction_quantity }}</td>
                                        <td class="text-truncate">{{ $item->construction_unit_price }}</td>
                                        <td class="text-truncate">{{ $item->construction_montant_designation }}</td>
                                        <td class="text-truncate">{{ $item->construction_cumul_montant_designation }}</td>
                                        <td class="text-center">
                                            <div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end m-0">
                                                    ...
                                                    <a href="{{ route('dashboard.detail_construction_expense_journal', $item->slug) }}"
                                                     class="dropdown-item text-dark delete-record">
                                                        <i class="mdi mdi-eye-arrow-right text-warning me-2"></i>
                                                        Voir
                                                    </a>

                                                    <a href="{{ route('dashboard.edit_construction_expense_journal', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
                                                     <i class="mdi mdi-text-box-edit-outline text-warning me-2"></i>
                                                        Modifier
                                                    </a>

                                                    <a href="{{ route('dashboard.delete_construction_expense_journal', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
