                                ...
                                <div class="card m-2">
                                    <div class="card-body">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12">
                                                    <div class="form-floating mb-3">
                                                        <input type="number" class="form-control" id="value" name="value" value="0" placeholder="">
                                        ...
                                        <div class="row pe-3">
                                            <div class="card m-2">
                                                <div class="card-body">
                                                    <h2 class="text-center fw-bolder" id="show-niv"> {{ $_data->niveau_etude }}</h2>
                                                    <hr>
                                                    <div class="row justify-content-center me-2">
                                                        <div class="col-lg-10 col-12">
                                                            <h5 class="ms-4 mb-3">Scolarité restant:<span class="ms-3 fw-bolder text-danger" id="scolarite"> {{ $_data->scolarite_reste.' F CFA' }}</span></h5>
                                                            <h5 class="ms-4 mb-3">Scolarité totale:<span class="ms-3 fw-bolder" id="scolarite"> {{ $_data->scolarite_total.' F CFA' }}</span></h5>
                                                            <h5 class="ms-4 mb-3">Année scolaire:<span class="ms-3 fw-bolder" id="school_year">{{ $_data->scolarite_years }}</span></h5>
