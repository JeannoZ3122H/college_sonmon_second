                                    ...
                                    <div class="d-flex justify-content-start flex-xl-row flex-md-column flex-sm-row flex-column">
                                        ...
                                        <div>
                                            <h4 class="fw-medium text-uppercase pb-1 text-black fw-bolder text-nowrap">
                                                Reçu d'inscription
                                                @if ($data->id < 10)
                                                    <span class="text-danger ms-2">#00{{ $data->id }}</span>
                                                @elseif ($data->id >= 10 && $data->id < 999)
                                                    <span class="text-danger ms-2">#0{{ $data->id }}</span>
                                                @elseif ($data->id > 999)
                                                    <span class="text-danger ms-2">#{{ $data->id }}</span>
                                                @endif
                                            </h4>
                                            <div class="mb-1">
                                                <span class="text-dark">Date:</span>
                                                <span class="text-black fw-bolder text-capitalize">{{ strftime("%d %B %Y", strtotime($data->created_at)) }}</span>
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex justify-content-between flex-wrap">
                                        <div class="my-3 me-3">
                                            ...
                                            <p class="mb-1">
                                                ...
                                                <span class="fw-bolder text-black">{{ $data->fname }}</span>
                                            </p>
                                            <p class="mb-1">
                                                <span class="me-2 text-dark">Prénoms:</span>
                                                <span class="fw-bolder text-black">{{ $data->lname }}</span>
                                            </p>
                                            <p class="mb-1">
                                                <span class="me-2 text-dark">Date de naissance:</span>
                                                <span class="fw-bolder text-black">{{ strftime("%d-%m-%Y", strtotime($data->date_naissance)) }}</span>
                                            </p>
                                            <p class="mb-1">
                                                <span class="me-2 text-dark">Classe:</span>
                                                <span class="fw-bolder text-black">{{ $data->niveau_etude }}</span>
                                            </p>
                                            <p class="mb-0">
                                                <span class="me-2 text-dark">Nº d'urgence:</span>
                                                <span class="fw-bolder text-black">{{ $data->emergency_phone }}</span>
                                            </p>
                                        </div>
                                        <div class="my-3">
                                            <h6>Bill To:</h6>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-md-end mt-2">
                                            <div class="invoice-calculations">
                                                <div class="d-flex justify-content-between mb-2">
                                                    ...
                                                    <h6 class="mb-0 pt-1 text-black fw-bolder">{{ ($data->scolarite_total - $data->scolarite_reste ).' F CFA' }}</h6>
                                                </div>
                                                <div class="d-flex justify-content-between mb-2">
                                                    <span class="w-px-100">Reste:</span>
                                                    <h6 class="mb-0 pt-1 text-black fw-bolder">{{ $data->scolarite_reste.' F CFA' }}</h6>
                                                </div>
                                                <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <h6 class="mb-0 pt-1 text-danger fw-bold">{{ $data->scolarite_total.' F CFA' }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-outline-secondary d-grid w-100 mb-3"
                                        target="_blank" href="{{ route('dashboard.print_inscription_invoice', $data->id) }}">
                                        <i class="mdi mdi-printer me-1"></i>
                                        Imprimer
                                    </a>
                                    @if($data->scolarite_reste > 0)
                    ...
                    <div class="offcanvas offcanvas-end" id="addPaymentOffcanvas" aria-hidden="true">
                        ...
                        <div class="offcanvas-body flex-grow-1">
                            <div class="d-flex justify-content-between bg-lighter p-2 mb-3">
                                ...
                                <p class="fw-medium mb-0">{{ $data->scolarite_total.' F CFA' }}</p>
                            </div>
                            <form action="{{ route('dashboard.buy_scolarite', $data->id) }}" method="POST" >
                                @csrf
                                <div class="input-group input-group-merge mb-4">
                                    <span class="input-group-text">F CFA</span>
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" disabled readonly id="invoiceAmount" value="{{ $data->scolarite_reste }}"
                                            class="form-control invoice-amount" placeholder="100" />
                                        <label for="invoiceAmount">Montant restant</label>
                                    </div>
                                </div>
                                <div class="form-floating form-floating-outline mb-4">
                                    <input id="date_inscription" disabled value="{{ strftime("%d %B %Y", strtotime($data->created_at)) }}" class="form-control invoice-date" type="text" />
