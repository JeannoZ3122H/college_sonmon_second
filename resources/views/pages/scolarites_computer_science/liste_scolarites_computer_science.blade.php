...
@section('title')
Liste des scolarités d'informatiques
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Liste des scolarités d'informatiques</span></h4>
    <a href="{{ route('dashboard.add_scolarites_computer_science') }}" class="btn btn-primary text-white mb-3 mt-1 me-2">
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end m-0">
                                                    <a href="{{ route('dashboard.edit_scolarites_computer_science', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
                                                     <i class="mdi mdi-text-box-edit-outline text-warning me-2"></i>
                                                     Modifier
                                                    </a>

                                                    <a href="{{ route('dashboard.delete_new_scolarites_computer_science', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
